...
onMounted(async () => {
  ...
  const [
    { EditorView, keymap, rectangularSelection, hoverTooltip, showTooltip, Decoration, tooltips, lineNumbers, highlightActiveLineGutter, highlightSpecialChars, dropCursor, crosshairCursor, ViewPlugin },
